    ...
    <main className="lg:flex  items-center p-5 lg:justify-center">
      <div className="pt-10 items-center relative gap-32 flex justify-center">
        ...
        <div className="max-w-xl xl:max-w-600">
          ...
          <div className="flex lg:gap-10 gap-16   justify-center lg:justify-start from-red-400 to-blue-500 text-center">
            <Link
              href="/features"
              className="content-center p-5 rounded-full mt-10 bg-gradient-to-r hover:from-pink-100 hover:to-blue-400 active:bg-blue-400 active:from-pink-100 active:to-blue-500"
            >
              Más información.
            </Link>
            <Link
